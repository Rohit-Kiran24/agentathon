...
export default function SettingsPage() {
    ...
    return (
        <main className="flex min-h-screen bg-black text-white selection:bg-white/30">
            <Sidebar />
            <section className="flex-1 pl-24 pr-8 py-8 h-screen overflow-y-auto w-full">
                <div className="max-w-3xl mx-auto">

                    <header className="mb-8">
                        <h1 className="text-3xl font-bold mb-2">{profile?.hasOnboarded ? "Account Settings" : "Setup Your Organization"}</h1>
